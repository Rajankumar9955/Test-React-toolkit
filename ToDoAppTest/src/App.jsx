...
import { useSelector,useDispatch } from "react-redux";
 ...
 const App=()=>{
    ...
    return(
       ...
       <div align="center"> Enter Your Task: <input  type="text" value={txtval} onChange={(e)=>{setTxtval(e.target.value)}}/>
        ...
        <h1 align="center">Add the Task and delete and edit the task</h1>
